  ...
  return (
    <div className="min-h-screen bg-creme flex flex-col w-full relative items-center">
      <div className="text-lg font-ultra m-28">
        If you are in immediate danger call 911 and if you cannot speak freely
        “order a pizza”
      </div>
      ...
      <div className="flex flex-row ml-60 gap-x-40 z-1">
        <div className="text-3xl font-ultra w-1/3 mt-24">
          We are here to provide discrete support those impacted by relationship
          abuse.
        </div>
        <Image
          src="/mushroom.png"
      ...
      <div className="text-4xl font-ultra mt-28">KNOW YOUR RIGHTS</div>
      <div className="text-3xl font-podkova mt-20 w-1/2">
        National statues are put in place to protect victims of domestic
        violence
      </div>
